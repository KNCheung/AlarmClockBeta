...
#define REG_TEMP_CLOCK_MSK	0x00000001
#define REG_DATE_MSK		0x00000002
#define REG_TEMP_MSK		0x00000004
#define REG_POMODORO_MSK	0x00000008
#define REG_COUNTER_MSK		0x00000010
#define REG_CLOCK_MSK		0x00000020
