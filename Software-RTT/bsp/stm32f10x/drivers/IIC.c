...
void IIC_ReadSeq(uint8_t Address,uint16_t Register,uint8_t* Data,uint16_t Length)
{  
  uint16_t i;
  IIC_Start();
  IIC_WriteByte(Address+IIC_Transmitter);
  IIC_GetACK();
  IIC_WriteByte((uint8_t)(Register>>8));
  IIC_GetACK();
  IIC_WriteByte((uint8_t)(Register%256));
  IIC_GetACK();
...
void IIC_WriteSeq(uint8_t Address,uint16_t Register,uint8_t* Data,uint16_t Length)
{  
  uint16_t i;
  IIC_Start();
  IIC_WriteByte(Address+IIC_Transmitter);
