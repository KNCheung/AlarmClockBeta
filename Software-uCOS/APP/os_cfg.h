...
#define OS_CFG_OBJ_TYPE_CHK_EN          1u   /* Enable (1) or Disable (0) object type checking对象类型检查                        */
#define OS_CFG_TS_EN                    0u   /* Enable (1) or Disable (0) timestamps  时间戳                                */
...
#define OS_CFG_MEM_EN                   1u   /* Enable (1) or Disable (0) code generation for MEMORY MANAGER          */
                                             ...
                                             /* --------------------- 使用互斥信号 MUTUAL EXCLUSION SEMAPHORES ------------------- */
